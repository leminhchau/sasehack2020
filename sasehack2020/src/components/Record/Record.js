          ...
          <div class="col-lg-7 col-md-12 col-12 d-flex align-items-center">
            <div class="about-text">
              <small class="small-text">
                <img
                  src="https://cdn.esquimaltmfrc.com/wp-content/uploads/2015/09/flat-faces-icons-circle-woman-9.png"
                  className="photo"
                ></img>
              </small>
              ...
              <div class="custom-btn-group mt-4">
                <a
                  href="https://images-na.ssl-images-amazon.com/images/I/61JU8DM6f-L._AC_UL1000_.jpg"
                  class="btn custom-btn custom-btn-bg"
                  onclick="getRandom()"
                >
                  Scan ID
                </a>
                ...
                <Grid item xs={6}>
                  <Paper className={classes.paper}>
                    <Card className={classes.root}>
                      ...
                      <CardActions disableSpacing>
                        <Button size="small">
                          <AnnouncementOutlinedIcon className="myreact-icons"></AnnouncementOutlinedIcon>
                        </Button>
                      </CardActions>
                    </Card>
                  </Paper>
